...
export async function uploadStorageFile(file: File, pathPrefix = "uploads") {
  if (!hasDbConfig()) throw new FnosDbError("Supabase environment variables are not configured.", 503);
