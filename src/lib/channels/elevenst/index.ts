...
function normalizeElevenstRow(
  ...
  const item: NormalizedOrderItem = {
    ...
    settlementAmount: numberValue(firstDeepText(row, ["stlPlnAmt", "정산예정금액", "settlementPlannedAmount", "plannedSettlementAmount", "settlementExpectAmount", "sttlAmt", "settlementAmount", "expectedSettlementAmount"])) || undefined,
